      ...
      def check_patron_exits
        ...
        patrons.each do |patron|
          ...
          if patron.visit_length > 0 && random_check > patron.enjoys_tavern
            ...
            MessageManager::MessageService.create_message(@game, :tavern_information, "#{patron.name} is leaving")
          else
      ...
      def check_patron_entries
        ...
        patrons.each do |patron|
          ...
          if random_check < @game.tavern_popularity
            ...
            MessageManager::MessageService.create_message(@game, :tavern_information, "#{patron.name} is entering")
          end
        end
      end
        ...
        patrons.each do |patron|
          if patron.credits > @game.beer_cost && @game.beers_in_stock > 0
            ...
            if rand < drink_order_probability
              ...
              MessageManager::MessageService.create_message(@game, :tavern_information, "#{patron.name} is ordering a drink")
            end
          end
        end
      end
